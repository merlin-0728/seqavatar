...
#   bash scripts/exps_zjumocap.sh part_moe_leg_unknown_route
#
# 常用覆盖方式：
#   GPU_id=3 bash scripts/exps_zjumocap.sh part_moe_leg
#   GPU_id=3 bash scripts/exps_zjumocap.sh part_moe_leg_unknown_route
...
case "$MODE" in
    ...
    *)
        ...
        echo "        Supported modes: original, part_moe_leg, part_budget, tri, tri_part, tri_gate, part_moe_leg_unknown_route, part_moe_leg_unknown_route_strong"
        exit 1
        ;;
esac
...
DATA_PATH=${DATA_PATH:-$REPO_ROOT/ZJU-MoCap}

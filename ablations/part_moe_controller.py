...
class PartMoeController:
    ...
    def _build_prior_only_labels(self, out_dir, iteration, gaussians, model_path):
        ...
        write_colored_ply(out_dir / "debug_smpl_prior.ply", gaussian_xyz, smpl_prior, schema=schema)
        write_colored_ply(out_dir / "gaussian_part_debug.ply", gaussian_xyz, final, schema=schema)
        ...
        print(f"  {label_path}")
        print(f"  counts: {label_counts(final, schema=schema)}")
